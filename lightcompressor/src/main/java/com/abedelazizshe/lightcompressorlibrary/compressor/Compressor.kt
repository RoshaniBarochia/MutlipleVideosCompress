        ...
        if (newWidth != 0 && newHeight != 0) {
            ...
            try {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                   // for (i in inputFormat.keys.iterator()){
                        Log.d("TAG", "start: ${inputFormat.keys}")
                  //  }
                }
...
//        val hasQTI = hasQTI()
//        Log.d("TAG", "prepareDecoder: hasQTI==> $hasQTI ")
//         val decoder = if (hasQTI) {
//             Log.d("TAG", " if prepareDecoder: hasQTI==> $hasQTI ")
//            MediaCodec.createByCodecName("c2.android.avc.decoder")
//         } else {
//             Log.d("TAG", " else prepareDecoder: hasQTI==> $hasQTI ")
